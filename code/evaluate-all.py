"""
    Evaluate all models and generate a final report
    
    Note that this script will not generate new validations.
    It will get all the results from the results/model
