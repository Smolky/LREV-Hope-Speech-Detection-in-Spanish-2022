"""
    ACL Abusive Comment Detection in Tamil output generation
...
def main ():
    ...
    dataset_name = 'aclabusive'
    
    
    # @var corpus_name String
    corpora = ['2022-tamil', '2022-tamil-english']


    # var parser
    parser = DefaultParser (description = 'ACL Abusive Comment Detection Submission')
    ...
    file_task_1 = 'umuteam_tamil.tsv'
    
    
    # @var file_task_2 String
    file_task_2 = 'umuteam_ta-en.tsv'
    ...
    for corpus_name in corpora:
        ...
        file_path = file_task_1 if corpus_name == '2022-tamil' else file_task_2
