"""
    ACL Depression output generation
...
def main ():
    ...
    # var parser
    parser = DefaultParser (description = 'ACL Depression Submission')
    ...
    for corpus_name in corpora:
        ...
        # Set the results
        test_df['class_label'] = model_values[corpus_name]
        
        
        # @var file_path String
        file_path = 'umuteam_' + args.test + '.tsv'
        ...
        test_df.to_csv (answer_path, header = True, index = False, sep = '\t', quoting = csv.QUOTE_NONE)
    ...
    with ZipFile (zip_file_path, 'w') as zipf:
        zipf.write (dataset.get_working_dir ('..', 'runs', args.test, file_path), arcname = file_path)
